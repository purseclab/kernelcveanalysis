...
int open_vuln_ipv4_udp_socket() {
    int socket_fd = open_connected_ipv4_udp_socket();
...
void open_many_sockets(int *fd_array, usize len) {
    for (usize i = 0; i < len; i++) {
        fd_array[i] = open_connected_ipv4_udp_socket();
    }
}
