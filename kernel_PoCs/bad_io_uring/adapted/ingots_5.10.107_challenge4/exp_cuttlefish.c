...
// Adaptation kernel name: ingots_5.10.107_challenge4
...
#define PAGE_OFFSET_BASE (0xffffffc0121bc890 - KERNEL_BASE)
#define PIPE_OPS_OFFSET (0xffffffc01201c4e8 - KERNEL_BASE)
#define INIT_OFFSET (0xffffffc012cbc4c0 - KERNEL_BASE)
