...
// Adaptation kernel name: pixel7_5.10.107
...
#define PAGE_OFFSET_BASE (0xffffffc012503450 - KERNEL_BASE)
#define PIPE_OPS_OFFSET (0xffffffc012362c68 - KERNEL_BASE)
#define INIT_OFFSET (0xffffffc012ffc440 - KERNEL_BASE)

// optinally define to turn off selinux
#define SELINUX_STATE_OFFSET (0xffffffc01316b9a8 - KERNEL_BASE)

// first 64 bit word of kernel image
#define KERNEL_START_WORD 0x14b17fff91005a4d
