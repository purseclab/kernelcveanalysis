...
MANUAL_RECORDS = [
    ...
    },
    {
        ...
        "summary": "SSD documents a detailed HFS+ kernel heap-overflow exploit achieving local privilege escalation on Ubuntu 22.04 active sessions. The upstream Linux-kernel CNA disputed/rejected the CVE scope because mounting the crafted image requires CAP_SYS_ADMIN in the initial namespace, so this record preserves the distro-specific precondition rather than treating it as universal.",
