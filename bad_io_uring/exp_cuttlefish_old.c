...
static long syz_io_uring_setup(volatile long a0, volatile long a1,
  ...
  void *vma1 = (void *)a2;
  void *vma2 = (void *)a3;
  // index ring buffer for submission queue
...
enum REG_N {
  IO_URING_FD = 1,
  IO_URING_SUBMISSION_QUEUE = 2,
  IO_URING_QEUEU_ENTRY_ARRAY = 3,
  LIBC_FD = 4,
  PROC_SELF_EXE_FD = 5,
};
...
enum CALL_N {
  ...
  OPEN_LIBC = 3,
  IO_URING_SUBMIT = 4,
  SET_STUFF_IN_MEMORY = 5,
  // r4 = open("/proc/self/exe")
  OPEN_SELF_EXE = 6,
  NOP = 7,
  MMAP_SELF_EXE = 8,
  IO_URING_ENTER = 9,
  NOP2 = 10,
  IO_URING_ENTER_WITH_PARENT = 11,
};
