...
"""
                        ...
                        if dynamic_analysis and source_image:
                            try:
                                from syzploit.SyzVerify.dynamic import DynamicAnalysisConfig, run_dynamic_analysis as verify_run_da
                                ...
                                parsed_crash = parse_crash_log(metadata.crash_report)
    ...
    if dynamic_analysis and source_image:
        try:
            ...
            with open(outname, 'w', encoding='utf-8') as of:
                _json.dump(da_result, of, indent=2)
