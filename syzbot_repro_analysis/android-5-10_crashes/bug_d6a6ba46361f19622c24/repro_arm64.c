...
*(uint16_t*)0x20000008 = 0x28de;
*(uint16_t*)0x2000000a = 0x1102;
...
*(uint8_t*)0x20000028 = 0xf9;
*(uint8_t*)0x20000029 = 1;
*(uint8_t*)0x2000002a = 0x22;
*(uint16_t*)0x2000002b = 5;
...
*(uint8_t*)0x20000035 = 0x50;
	res = -1;
res = syz_usb_connect(/*speed=USB_SPEED_FULL*/2, /*dev_len=*/0x36, /*dev=*/0x20000000, /*conn_descs=*/0);
	if (res != -1)
		r[0] = res;
syz_usb_control_io(/*fd=*/r[0], /*descs=*/0, /*resps=*/0);
*(uint32_t*)0x20000040 = 0x2c;
*(uint64_t*)0x20000044 = 0x20000200;
memcpy((void*)0x20000200, "\x20\x0b\x40\x00\x00\x00\x28\xb1", 8);
*(uint64_t*)0x2000004c = 0;
*(uint64_t*)0x20000054 = 0;
*(uint64_t*)0x2000005c = 0;
*(uint64_t*)0x20000064 = 0;
syz_usb_control_io(/*fd=*/r[0], /*descs=*/0x20000040, /*resps=*/0);
memcpy((void*)0x20002300, "/dev/hidraw#\000", 13);
syz_open_dev(/*dev=*/0x20002300, /*id=*/0, /*flags=*/0);
