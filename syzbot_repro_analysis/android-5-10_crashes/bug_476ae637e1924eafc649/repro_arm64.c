...
memcpy((void*)0x20000000, "/dev/bus/usb/00#/00#\000", 21);
	res = -1;
res = syz_open_dev(/*dev=*/0x20000000, /*id=*/0x3f6, /*flags=O_NOATIME|O_WRONLY*/0x40001);
	if (res != -1)
		r[0] = res;
*(uint32_t*)0x20000040 = 0;
	syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x80045505, /*arg=*/0x20000040ul);
memcpy((void*)0x20000000, "/dev/bus/usb/00#/00#\000", 21);
	res = -1;
res = syz_open_dev(/*dev=*/0x20000000, /*id=*/0x3f6, /*flags=O_NOATIME|O_WRONLY*/0x40001);
	if (res != -1)
		r[1] = res;
*(uint32_t*)0x20000040 = 0;
*(uint32_t*)0x20000044 = 0x5516;
*(uint64_t*)0x20000048 = 0;
	syscall(__NR_ioctl, /*fd=*/r[1], /*cmd=*/0xc0105512, /*arg=*/0x20000040ul);
memcpy((void*)0x20000000, "/dev/bus/usb/00#/00#\000", 21);
	res = -1;
res = syz_open_dev(/*dev=*/0x20000000, /*id=*/0x3f6, /*flags=O_NOATIME|O_WRONLY*/0x40001);
	if (res != -1)
...
*(uint32_t*)0x20000040 = 1;
	inject_fault(3);
	syscall(__NR_ioctl, /*fd=*/r[2], /*cmd=*/0x80045505, /*arg=*/0x20000040ul);
memcpy((void*)0x20000000, "/dev/bus/usb/00#/00#\000", 21);
	res = -1;
res = syz_open_dev(/*dev=*/0x20000000, /*id=*/0x3f6, /*flags=O_NOATIME|O_WRONLY*/0x40001);
	if (res != -1)
...
*(uint32_t*)0x20000084 = 0x5517;
*(uint64_t*)0x20000088 = 0;
	syscall(__NR_ioctl, /*fd=*/r[3], /*cmd=*/0xc0105512, /*arg=*/0x20000080ul);
