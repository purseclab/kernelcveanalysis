...
memcpy((void*)0x200003c0, "/dev/loop-control\000", 18);
	res = syscall(__NR_openat, /*fd=*/0xffffff9cul, /*file=*/0x200003c0ul, /*flags=FASYNC*/0x2000, /*mode=*/0);
	if (res != -1)
		r[0] = res;
	syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x4c81, /*num=*/0ul);
	inject_fault(77);
	syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x4c80, /*num=*/0ul);
