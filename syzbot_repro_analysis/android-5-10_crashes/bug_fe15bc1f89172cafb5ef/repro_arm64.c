...
*(uint8_t*)0x20000381 = 0x7f;
*(uint16_t*)0x20000382 = 0x20f;
	syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x4b47, /*arg=*/0x20000380ul);
*(uint16_t*)0x20001080 = 0;
*(uint16_t*)0x20001082 = 0;
*(uint16_t*)0x20001084 = 0;
*(uint16_t*)0x20001086 = 0;
*(uint16_t*)0x20001088 = 1;
*(uint16_t*)0x2000108a = 0x7f;
...
*(uint16_t*)0x200010a6 = 0;
	syscall(__NR_ioctl, /*fd=*/(intptr_t)-1, /*cmd=*/0x40304580, /*arg=*/0x20001080ul);
memcpy((void*)0x20000140, "/dev/input/event#\000", 18);
	res = -1;
res = syz_open_dev(/*dev=*/0x20000140, /*id=*/2, /*flags=O_TRUNC|O_NONBLOCK|O_NOCTTY|O_NOATIME|O_LARGEFILE|FASYNC|0x800001*/0x862b01);
	if (res != -1)
		r[1] = res;
memset((void*)0x20000040, 226, 1);
	syscall(__NR_write, /*fd=*/r[1], /*buf=*/0x20000040ul, /*count=*/0x2250ul);
