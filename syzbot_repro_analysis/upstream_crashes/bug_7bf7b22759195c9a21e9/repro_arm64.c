...
memcpy((void*)0x200008c0, "nl802154\000", 9);
	res = -1;
res = syz_genetlink_get_family_id(/*name=*/0x200008c0, /*fd=*/-1);
	if (res != -1)
		r[0] = res;
	res = -1;
...
res = syz_init_net_socket(/*domain=*/0x10, /*type=*/3, /*proto=*/0x10);
	if (res != -1)
		r[2] = res;
memcpy((void*)0x20000940, "wpan1\000\000\000\000\000\000\000\000\000\000\000", 16);
	res = syscall(__NR_ioctl, /*fd=*/r[2], /*cmd=*/0x8933, /*arg=*/0x20000940ul);
	if (res != -1)
r[3] = *(uint32_t*)0x20000950;
