...
res = syz_init_net_socket(/*fam=*/0x1f, /*type=*/5, /*proto=*/2);
		...
		break;
	case 1:
*(uint16_t*)0x20000580 = 0x1f;
memset((void*)0x20000582, 170, 5);
*(uint8_t*)0x20000587 = 0;
		syscall(__NR_connect, /*fd=*/r[0], /*addr=*/0x20000580ul, /*addrlen=*/8ul);
		break;
	case 2:
*(uint16_t*)0x20000080 = 0x1f;
memset((void*)0x20000082, 0, 6);
		syscall(__NR_connect, /*fd=*/r[0], /*addr=*/0x20000080ul, /*addrlen=*/8ul);
		break;
	}
