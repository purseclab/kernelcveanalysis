...
memset((void*)0x2000011c, 0, 12);
	res = -1;
res = syz_io_uring_setup(/*entries=*/0x62a0, /*params=*/0x20000100, /*ring_ptr=*/0x20000000, /*sqes_ptr=*/0x20000000);
	if (res != -1)
		r[0] = res;
*(uint64_t*)0x20000000 = 0x430;
	syscall(__NR_io_uring_enter, /*fd=*/r[0], /*to_submit=*/0x40b2, /*min_complete=*/0, /*flags=*/0ul, /*sigmask=*/0x20000000ul, /*size=*/8ul);
	return 0;
}
