...
void execute_one(void)
{
	...
	syscall(__NR_mmap, /*addr=*/0ul, /*len=*/0x40009ul, /*prot=*/0xdful, /*flags=*/0x9b72ul, /*fd=*/7, /*off=*/0x28000ul);
memcpy((void*)0x200000c0, "/sys/kernel/debug/bluetooth/hci0/force_devcoredump\000", 51);
	res = syscall(__NR_openat, /*fd=*/0xffffffffffffff9cul, /*file=*/0x200000c0ul, /*flags=O_RDWR*/2, /*mode=*/0);
	if (res != -1)
		r[0] = res;
