...
memcpy((void*)0x20000040, "/dev/dri/card#\000", 15);
	res = -1;
res = syz_open_dev(/*dev=*/0x20000040, /*id=*/2, /*flags=O_APPEND*/0x400);
	if (res != -1)
		r[0] = res;
...
*(uint32_t*)0x200001bc = 0;
	res = syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0xc04064a0, /*arg=*/0x20000180ul);
	if (res != -1)
r[1] = *(uint32_t*)0x200000c0;
*(uint64_t*)0x200001c0 = 0;
*(uint32_t*)0x200001c8 = 0;
*(uint32_t*)0x200001cc = r[1];
	res = syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0xc06864a1, /*arg=*/0x200001c0ul);
	if (res != -1)
...
*(uint64_t*)0x20000250 = 7;
	syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0xc01864b0, /*arg=*/0x20000240ul);
