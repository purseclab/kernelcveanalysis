...
memcpy((void*)0x20000240, "lo\000\000\000\000\000\000\000\000\000\000\000\000\000\000", 16);
	res = syscall(__NR_ioctl, /*fd=*/r[2], /*cmd=*/0x8933, /*arg=*/0x20000240ul);
	if (res != -1)
...
*(uint32_t*)0x20000248 = 0x70bd2c;
*(uint32_t*)0x2000024c = 0x25dfdbff;
*(uint8_t*)0x20000250 = 0x16;
...
*(uint32_t*)0x200002f0 = 0x8000000;
	syscall(__NR_sendmsg, /*fd=*/r[0], /*msg=*/0x200002c0ul, /*f=MSG_NOSIGNAL|MSG_MORE|MSG_EOR*/0xc080ul);
	return 0;
}
