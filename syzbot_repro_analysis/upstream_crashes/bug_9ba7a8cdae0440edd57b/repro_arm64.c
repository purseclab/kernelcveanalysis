...
memcpy((void*)0x200000c0, "./binderfs/binder0\000", 19);
	res = syscall(__NR_openat, /*fd=*/0xffffffffffffff9cul, /*file=*/0x200000c0ul, /*flags=*/0, /*mode=*/0);
	if (res != -1)
		r[0] = res;
	syscall(__NR_ioctl, /*fd=*/r[0], /*cmd=*/0x40046207, /*arg=*/0ul);
memcpy((void*)0x20000100, "./binderfs/binder0\000", 19);
	res = syscall(__NR_openat, /*fd=*/0xffffffffffffff9cul, /*file=*/0x20000100ul, /*flags=O_NONBLOCK|O_RDWR|0x1000*/0x1802, /*mode=*/0);
	if (res != -1)
		r[1] = res;
*(uint64_t*)0x20000000 = 8;
*(uint64_t*)0x20000008 = 0;
*(uint64_t*)0x20000010 = 0x200003c0;
*(uint32_t*)0x200003c0 = 0x40046304;
*(uint32_t*)0x200003c4 = 0;
*(uint64_t*)0x20000018 = 0;
*(uint64_t*)0x20000020 = 0;
*(uint64_t*)0x20000028 = 0;
	syscall(__NR_ioctl, /*fd=*/r[1], /*cmd=*/0xc0306201, /*arg=*/0x20000000ul);
...
*(uint32_t*)0x200002c0 = 0x400c6313;
*(uint32_t*)0x200002c4 = 0;
*(uint64_t*)0x200002c8 = 0;
*(uint64_t*)0x20000258 = 0;
*(uint64_t*)0x20000260 = 0;
*(uint64_t*)0x20000268 = 0;
	syscall(__NR_ioctl, /*fd=*/r[2], /*cmd=*/0xc0306201, /*arg=*/0x20000240ul);
